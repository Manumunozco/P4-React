    ...
    <>
      <div id="footerId" className="divFooter">
        ...
        <div className="address">
          ...
          <div className="map">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2889.0598807317597!2d172.6910579!3d-43.605294799999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6d3226f7f8dd2c43%3A0xf064833d09652883!2s39%20Harbour%20View%20Terrace%2C%20Cass%20Bay%2C%20Lyttelton%208082!5e0!3m2!1ses!2snz!4v1692957409505!5m2!1ses!2snz"
              width="250"
              height="200"
              style={{ border: 0 }}
              allowFullScreen=""
        ...
        <div className="socialMedia">
          <div className="contact">
            <a href="">
              <img
                className="social"
                src="/assets/imges/instagram.png"
                alt=""
              />
            </a>
          ...
          <div className="contact">
            <a href="">
              <img className="social" src="/assets/imges/face.png" alt="" />
            </a>
            <h2 className="h2-footer">Oli Bakery</h2>
          </div>
